...
class BCDU_net_D3(nn.Module):
    def __init__(self, N=256, num_channels=3, num_classes=1):
        ...
        self.conv_lstm6 = ConvLSTM2D(
            256, 128, kernel_size=3, padding=1, go_backwards=True
        )
        self.conv6 = ConvBlock(128, 256)

        self.up7 = UpConv(256, 128)
        self.conv_lstm7 = ConvLSTM2D(
            128, 64, kernel_size=3, padding=1, go_backwards=True
        )
        self.conv7 = ConvBlock(64, 128)

        self.up8 = UpConv(128, 64)
        self.conv_lstm8 = ConvLSTM2D(
            64, 32, kernel_size=3, padding=1, go_backwards=True
        )
