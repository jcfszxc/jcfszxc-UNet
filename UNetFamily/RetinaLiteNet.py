...
class TransFuseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        transformer_input = conv3.permute(0, 2, 3, 1).reshape(batch_size, height * width, channels)
        ...
        transformer_output = transformer_output.expand(batch_size, height, width, channels).permute(0, 3, 1, 2)
